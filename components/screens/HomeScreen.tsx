...
export function HomeScreen() {
  ...
  const { user } = useAuth(); // Get the globally available user data from the context
  ...
  const quickActions = [
    ...
    { label: "My Reports", description: "Track your reports", action: () => navigation.navigate("MyReports" as never), icon: "check-square" as const, color: "#f0fdf4", iconColor: "#16a34a", urgent: false },
  ...
  // This is a safeguard. It shows a loading spinner until the user data is ready.
  if (!user) {
    return (
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {user.role === "authority" && (
          <View style={styles.section}>
            <TouchableOpacity style={styles.authorityButton} onPress={() => navigation.navigate("Authority" as never)}>
        ...
        <View style={styles.section}>
          <TouchableOpacity style={styles.mapPlaceholder}>
            ...
            <Text style={styles.mapPlaceholderSubtext}>Tap to view nearby issues</Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
    ...
    mapPlaceholder: { backgroundColor: "white", borderRadius: 12, padding: 24, alignItems: "center", shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
    mapPlaceholderLabel: { fontSize: 18, fontWeight: "600", color: "#374151", marginTop: 12 },
    mapPlaceholderSubtext: { fontSize: 14, color: "#6b7280", marginTop: 4 },
